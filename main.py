...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    [trainy_mod3, testy_mod3] = update_y(train_y, test_y)

    theta, cost_function_history = softmax_regression(train_x, trainy_mod3, temp_parameter, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
    plot_cost_function_over_time(cost_function_history)
    # Save the model parameters theta obtained from calling softmax_regression to disk.

    test_error = compute_test_error_mod3(test_x, testy_mod3, theta, temp_parameter)
    write_pickle_data(theta, "./theta.pkl.gz")
...
# print('run_softmax_on_MNIST_mod3()', run_softmax_on_MNIST_mod3(temp_parameter=1))
